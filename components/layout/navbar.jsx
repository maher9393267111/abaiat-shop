...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="  relative flex flex-wrap items-center justify-between px-2 py-3 bg-gold">
          ...
          >
            <ul className="flex flex-col !font-ib arabic  lg:flex-row list-none lg:ml-auto">
              ...
              <li className="nav-item">
                ...
                >
                  {/* <Icon  icon="lucide:home" className="text-lg leading-lg text-white opacity-75"/>   */}
                  <span className="ml-2 "> الرجالي </span>
                </Link>
              </li>
              ...
              <li className="nav-item">
                ...
                >
                  {/* <Icon  icon="lucide:home" className="text-lg leading-lg text-white opacity-75"/>   */}
                  <span className="ml-2 "> النسائي</span>
                </Link>
              </li>
              ...
              <li className="nav-item">
                ...
                >
                  {/* <Icon  icon="lucide:home" className="text-lg leading-lg text-white opacity-75"/>   */}
                  <span className="ml-2 "> الاطفال</span>
                </Link>
              </li>
