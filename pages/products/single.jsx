...
<div className=" min-h-[90vh]">
      ...
      {product?.title && (
       ...
       <BreadCrumb category={product.category} name={product.title} id={product?.id} />
...
<img
         ...
         <div className="mx-auto pt-4 pb-16 px-4 ">
           <div className="lg:col-spn-2 lg:pr-8">
             <h1 className="text-2xl font-bold font-lora tracking-tight text-gray-900 sm:text-3xl">{product.title}</h1>
           </div>
